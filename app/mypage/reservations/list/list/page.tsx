        ...
        <div className="rounded-xl bg-gradient-to-r from-blue-200/60 via-blue-100/60 to-cyan-100/60 px-6 py-5 mb-6 flex flex-col gap-3 border border-blue-100/50">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-4 py-2 rounded-md bg-white/40 backdrop-blur-sm text-blue-800 text-sm font-medium hover:bg-white/50 transition-all duration-200 border border-blue-100/50"
            >🏠 홈으로</button>
          </div>
        </div>
